package com.joross.web.stepDefs;

import com.joross.web.helper.Utility;
import com.joross.web.pages.*;
...
public class LoginStepDef {
    ...
    com.joross.web.Order dataTestOrder;
    com.joross.web.PlaceOrder dataPlaceOrder;
    ...
    public LoginStepDef() {
        ...
        dataTestOrder = new com.joross.web.Order();
        cartPage = new CartPage();
        dataPlaceOrder = new com.joross.web.PlaceOrder();
